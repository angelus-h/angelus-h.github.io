...
### Portrait Formats (1850s-1910s)

| Format | Size (cm) | Size (inches) | Era | Use |
|--------|-----------|--------------|-----|-----|
| **Carte-de-Visite (CDV)** | 10 × 6 | 4 × 2.5 | 1854-1890s | Visiting cards, albums |
| **Cabinet Card** | 16.5 × 10.8 | 6.5 × 4.25 | 1866-1910s | Portraits, replaced CDV |
| **Imperial** | 25 × 18 | 10 × 7 | 1860s-1900s | Large portraits |
| **Boudoir** | 21.6 × 13.3 | 8.5 × 5.25 | 1870s-1900s | Intimate portraits |
| **Stereograph** | 17.8 × 8.9 | 7 × 3.5 | 1850s-1930s | 3D viewing (twin images) |
...
### The Enemy Trinity
1. **Light** - Fading, discoloration, embrittlement
2. **Heat** - Accelerated chemical degradation
3. **Humidity** - Mold, oxidation, adhesion

### Optimal Storage
- **Temperature:** 15-20°C (59-68°F)
- **Relative Humidity:** 30-40% (strict control!)
- **Light:** Darkness when not displayed
- **Materials:** Acid-free, lignin-free paper/board

### Quick Rules

**DO:**
- Wash hands before handling
- Use cotton gloves for metal/glass
- Store in stable environment
- Use acid-free materials
- Interleave stacked items

**DON'T:**
- Touch image surface
- Use rubber bands or paper clips
- Store in basements (humid) or attics (hot)
- Use PVC plastic ("vinyl")
- Expose to direct sunlight

### Damage Types at a Glance

| Symptom | Cause | Process Affected |
|---------|-------|-----------------|
| **Yellowing** | Albumen aging, acidic materials | Albumen prints, paper |
| **Silver Mirroring** | Humidity + sulfur | Gelatin silver prints |
| **Fading** | Light, poor fixing | All silver processes |
| **Vinegar Smell** | Acetate degradation | Safety film |
| **Rust** | Moisture | Tintypes |
| **Cracking** | Low humidity, temp cycling | Albumen, gelatin emulsions |
| **Mold** | High humidity (>60%) | All organic materials |

---

## Key Chemistry Terms

### Silver Compounds (Most Processes)
- **AgNO₃** (Silver Nitrate) - Light sensitizer
- **AgCl** (Silver Chloride) - Printing-out papers
- **AgBr** (Silver Bromide) - Film, developing-out papers
- **Na₂S₂O₃** ("Hypo") - Fixer, removes unexposed silver

### Development
- **Pyrogallol** - Early developer (wet plate era)
- **Hydroquinone** - Modern developer
- **Metol** - Fast-acting developer

### Toning
- **Gold Chloride** - Increases longevity, purple-brown tones
- **Selenium** - Protective toning for modern prints
- **Sulfide** - Sepia tones, increased stability
...
| Year | Innovation |
|------|-----------|
| **1839** | Daguerreotype announced (Daguerre) |
| **1841** | Calotype patented (Talbot) - first negative |
| **1842** | Cyanotype invented (Herschel) |
| **1850** | Albumen paper introduced |
| **1851** | Wet collodion process (Archer) |
| **1854** | Ambrotype introduced |
| **1856** | Tintype/Ferrotype introduced |
| **1871** | Gelatin dry plate (Maddox) - game changer |
| **1880s** | Gelatin silver printing paper standard |
| **1888** | Kodak #1 camera - "You press the button, we do the rest" |
| **1889** | Nitrate roll film (Kodak) |
| **1900** | Brownie camera - photography for the masses |
| **1935** | Kodachrome (first practical color film) |
| **1951** | Nitrate film production ends |
| **1960s** | Polyester film base introduced |
| **2000s** | Digital photography becomes dominant |

---

## When to Consult a Conservator

**DIY (Safe for Beginners):**
- Re-housing in acid-free materials
- Basic cleaning (dust removal with soft brush)
- Creating access copies (scans)
- Environmental control (climate monitoring)

**EXPERT REQUIRED:**
- Stuck-together photographs (DO NOT force apart)
- Mold/fungus (health hazard + delicate treatment)
- Torn emulsions
- Chemical restoration/toning
- Daguerreotype cleaning (extremely delicate)
- Nitrate film handling (safety issue)
...
**Conservation:**
- Lavédrine, Bertrand. "Photographs of the Past: Process and Preservation" (2009)

**Technical/Historical:**
- Crawford, William. "The Keepers of Light" (1979) - working guide to historical processes

**Online:**
- Graphics Atlas: http://www.graphicsatlas.org (process identification)
...
1. **Every photograph degrades from birth** - proper storage slows it down
2. **Know the process** - identification guides conservation decisions
3. **Enemy trinity:** Light + Heat + Humidity = destruction
4. **When in doubt, don't** - consult a professional conservator
5. **Digitize for access** - handle copies, preserve originals
6. **Acid-free is key** - use proper archival materials
7. **Nitrate film = DANGER** - isolate and duplicate immediately

---

**Sources:**
- International museum and conservation archives
...
*"Photography is the only art form so closely tied to its technology - technical development enabled its birth and will cause its end."*
